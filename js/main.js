...
const perguntas = [
    new Pergunta("Qual é a diferença entre == e === em JavaScript?", [" == compara apenas os valores dos operandos, enquanto === compara tanto os valores quanto os tipos de dados.", " == compara tanto os valores quanto os tipos de dados dos operandos, enquanto === compara apenas os valores.", " == é utilizado para atribuição de valores, enquanto === é utilizado para comparação de valores.", "Não há diferença entre == e ===, ambos realizam comparações de valores e tipos de dados da mesma forma."], 1),
    new Pergunta("Qual é a diferença entre let e var em JavaScript?", [" let é usado para declarar variáveis globais, enquanto var é usado para variáveis locais.", " let tem escopo de bloco, o que significa que só está acessível dentro do bloco onde foi declarado, enquanto var tem escopo de função.", " let e var são sinônimos e podem ser usados de forma intercambiável.", " let é uma palavra-chave reservada em JavaScript, enquanto var não é."], 1),
...
function mostrarResultado() {
    ...
    resultado.style.background = "rgba(84, 150, 75, 0.911)"
